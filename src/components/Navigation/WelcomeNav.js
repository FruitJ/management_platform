                    ...
                    <Row>
                            ...
                            <Row>
                                <Col span = { 12 }>
                                    <div className = "nav-app-content">
                                        <img
                                            ...
                                            alt = "宽广" title = "宽广" className = "kg-logo" />
                                ...
                                <Col span = { 12 }>
                                    <Row className = "nav-func-module">
                                        <Col span = { 8 } className = "contact">Contact us</Col>
                                        <Col span = { 8 } className = "join">Join us</Col>
                                        <Col span = { 8 }> </Col>
                                    </Row>
                                </Col>
                            </Row>
                        ...
                        <Col span = { 12 }>
                            <Row className = "nav-account-module">
                                ...
                                <Col span = { 4 } className = "nav-btn-login">
                                    <div>
                                        Login
                                    </div>
                                </Col>
