...
// const GoodsCategory = (props) => {
    ...
    onSelect = (selectedKeys, info) => {
        ...
        if(Array.from(tar.classList).includes("category-addChild")) {
            ...
            // let parentText = "";
            try{
                parentText = info.node.selectHandle.parentNode.parentNode.parentNode.children[1].firstChild.firstChild.firstChild.firstChild.innerHTML;
            }catch(err) {
                parentText = "无";
            }
            ...
            if(this.props.goodsCategory.isShowDelCategoryModel) {
                if(!this.props.isShowDelGoodsCategory) { // del_currentId
  ...
  dynamicTreeNodeGenerator = (data) => data.map((item, index) => {
      count += 1;
                            ...
                            (
                                <div style={{
                                    ...
                                    { item.step < 4 ? (
                                        <>
                                            ...
                                            <Modal
                                                ...
                                                onOk={(ev) => { this.props.onAddChildCategoryModalOk(ev, parentId) }}
                                                onCancel={ () => { this.props.onAddChildCategoryModalCancel } }
                                                style={{
                                                    position: "relative",
                                                    zIndex: "100000",
                                                }}
                                            >
                                                <Row>
                                                    ...
                                                    <Col span={18}>
                                                        <Input value = { this.props.goodsCategory.input_addChildCategoryVal } onChange = { (ev) => { this.props.onChangeAddChildCategoryVal(ev) } } placeholder="请输入分类名称" id="category" />
                                                    </Col>
                                                </Row>
                                            </Modal>
                                    ...
                                    <Modal
                                        ...
                                        onOk={() => { this.props.onEditCategoryModalOk(currentId) } }
                                        ...
                                        <Row>
                                            ...
                                            <Col span={18}>
                                                <Input placeholder="请输入分类名称"
                                                       onChange = { (ev) => { this.props.onChangeEditCategoryVal(ev) } }
                                                />
                                            </Col>
                                        </Row>
                                        <Row style={{
                                    ...
                                    <Divider type="vertical" />
                                    <Popconfirm title="确定删除该分类 ? "
                                                icon={
                                                    <Icon type="question-circle-o"
                                                            style={{ color: 'red' }} />
                                                }
                                                onConfirm = { () => { this.props.onDelCategoryModalOk(del_currentId) } }
                                                onCancel = { () => { this.props.onDelCategoryModalCancel() } }
                                    >
      ...
      return (
          <div>
              <PageHeader
                  ...
                  subTitle="商品分类"
              />
              <div className = "manage-category" style={{
                  backgroundColor: "#FFF",
                  marginTop: "24px",
                  paddingTop: "24px",
                  paddingBottom: "45px",
                  ...
                  <Row style={{
                      ...
                      <Col span={24}>
                          <Button type="primary"
                                  ...
                                  onClick = { () => { this.props.onOpenNewAddCategoryModal() } }
                          >新增分类</Button>
                          <Modal
                              title="新增分类"
                              visible={this.props.goodsCategory.isShowAddCategoryModel}
                              onOk={ () => { this.props.onAddCategoryModalOk() } }
                          ...
                          >
                              <Row>
                                  ...
                                  <Col span={18}>
                                      <Input placeholder = { parentText }
                                             value = { this.props.goodsCategory.input_addCategoryVal }
                                             onChange = { (ev) => { this.props.onChangeAddCategoryVal(ev) } }
                                      />
                                  </Col>
                              </Row>
                          </Modal>
