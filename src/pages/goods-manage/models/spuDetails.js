...
import {
	reqSpuDetailsInfoService,
} from '@/services/spuDetails';
...
export default {
	...
	effects: {
		...
		*toSpuDetails({ payload: spu_id }, { call, put }) {
			...
			yield put(routerRedux.push(`/goods-manage/update/spu-details:${ spu_id }`));
			
			// 存储 spu_id
		},
		*getSpuDetailInfo({ payload: spu_id }, { call, put }) {
